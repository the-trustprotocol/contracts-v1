...
contract DeployV1 is ScaffoldETHDeploy {
    /**
    ...
    function run() external ScaffoldEthDeployerRunner {
        ...
        ERC1967Proxy settingsProxy =
            new ERC1967Proxy(address(settingsImpl), abi.encodeCall(UserFactorySettings.initialize, ()));
        ...
        ERC1967Proxy userSettingsProxy =
            new ERC1967Proxy(address(userSettingsImpl), abi.encodeCall(UserSettings.initialize, ()));
        ...
        ERC1967Proxy registryProxy =
            new ERC1967Proxy(address(registryImpl), abi.encodeCall(Registry.initialize, ("1.0")));
        ...
        ERC1967Proxy identityRegistryProxy =
            new ERC1967Proxy(address(identityRegistryImpl), abi.encodeCall(IdentityRegistry.initialize, ()));
        ...
        ERC1967Proxy userFactoryProxy = new ERC1967Proxy(
